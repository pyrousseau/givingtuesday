...
<div class="block block__actions block__actions--form block__form">
    ...
    <div class="inner-wrapper form-wrapper">
        <form class="add-event" enctype="multipart/form-data">
            <!-- action="#" method="post" -->
            ...
            <div class="input-block-wrapper input-block-wrapper__i-am">
                ...
                <div class="input-wrapper">
                    ...
                    <div class="inner-input-wrapper">
                        <div class="input-column2">
                            ...
                            <div class="error_text">Veuillez respecter le format requis. Le champ doit comporter au
                                moins 2
                                caractères.</div>
                        </div>
                        ...
                        <div class="input-column2">
                            <div class="checkboxes_multiselect">
                                ...
                                <div id="sa_checkboxes">
                                    <label for="sa_1"><input type="checkbox" id="sa_1" name="sa_1"
                                            value="sa_1" />Caritatif
                                        / solidarité</label>
                                    <label for="sa_2"><input type="checkbox" id="sa_2" name="sa_2"
                                            value="sa_2" />Sport</label>
                                    <label for="sa_3"><input type="checkbox" id="sa_3" name="sa_3"
                                            value="sa_3" />Confessionnel</label>
                                    <label for="sa_4"><input type="checkbox" id="sa_4" name="sa_4"
                                            value="sa_4" />Collectivités</label>
                                    <label for="sa_5"><input type="checkbox" id="sa_5" name="sa_5"
                                            value="sa_5" />Culture</label>
                                    <label for="sa_6"><input type="checkbox" id="sa_6" name="sa_6"
                                            value="sa_6" />Enseignement supérieur</label>
                                    <label for="sa_7"><input type="checkbox" id="sa_7" name="sa_7"
                                            value="sa_7" />Environnement</label>
                                    <label for="sa_8"><input type="checkbox" id="sa_8" name="sa_8"
                                            value="sa_8" />Hospitalier</label>
                                    <label for="sa_9"><input type="checkbox" id="sa_9" name="sa_9"
                                            value="sa_9" />Recherche</label>
                                    <label for="sa_10"><input type="checkbox" id="sa_10" name="sa_10"
                                            value="sa_10" />Santé</label>
                                    <label for="sa_11"><input type="checkbox" id="sa_11" name="sa_11"
                                            value="sa_11" />Tous
                                        secteurs</label>
                                </div>
                                <div class="error_text error_secteur">Vous devez sélectionner au moins un secteur.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="input-wrapper">
                    ...
                    <div class="inner-input-wrapper">
                        ...
                        <div class="error_text">Veuillez respecter le format requis. Le champ doit comporter au moins 2
                            caractères.</div>
                    </div>
                </div>
            </div>
            <div class="input-block-wrapper input-block-wrapper__gender">
                ...
                <div class="input-wrapper">
                    <input type="radio" id="g-0<?php echo $i; ?>" name="gender" value="<?php echo $c; ?>"
            ...
            <div class="input-block-wrapper input-block-wrapper__events">
                ...
                $e = 0; foreach ($type_event as $te => $event) { $e++; ?>
                <div class="input-wrapper">
                    <input type="radio" id="e-0<?php echo $e; ?>" name="event" value="<?php echo $te; ?>"
                        <?php if ($e == 1) { echo 'checked';} ?>>
                    <label class="event-label" for="e-0<?php echo $e; ?>"><?php echo $event; ?></label>
                    <?php if($te == 'physique'){ ?>
                    <div class="inner-input-wrapper">
                        <select name="region">
            ...
            <div class="input-block-wrapper input-block-wrapper__category">
                ...
                <div class="input-wrapper">
                    <input type="radio" id="c-0<?php echo $c; ?>" name="category" value="<?php echo $ce; ?>"
            ...
            <div class="input-block-wrapper input-block-wrapper__info">
                <div class="input-column">
                    ...
                    <div class="input-wrapper">
                        <input type="text" name="event_date" id="date1"
                            placeholder="Date de l’évènement (ex: 01/01/2019)">
                ...
                <div class="input-column">
                    <div class="input-wrapper">
                        <textarea name="description"
                            placeholder="Description de l’évènement (250 caractères maximum)"></textarea>
                        <div class="error_text">Veuillez respecter le format requis. Le champ doit comporter au moins 2
                            caractères dans la limite de 250 caractères.</div>
                    </div>
                </div>
            </div>
                ...
                <div class="input-column">
                    <div class="input-wrapper">
                        <div class="input-container-file">
                            ...
                            <p class="text-file-upload-desktop">Glissez / déposez ici le visuel de l'évènement, ou votre
                                logo, au format 16/9<br />
                                ou <u>choisissez un fichier sur votre ordinateur</u></p>
                            <p class="text-file-upload-mobile">Téléchargez ici le visuel<br />de l’évènement, ou votre
                                logo,<br />au format 16/9</p>
                            <p id="file-name"></p>
                        </div>
            ...
            <div class="input-block-wrapper input-block-wrapper__autorise-communication">
                <div class="input-wrapper">
                    ...
                    <label for="autorise_communication" class="text-block">J'accepte de recevoir des informations dans
                        le cadre du mouvement GivingTuesday France. Don’t worry! Vos données ne seront ni vendues, ni
                        échangées. Elles nous permettent uniquement de vous tenir au courant de GivingTuesday
                        France.</label>
            ...
            <div class="merci-popup">
                ...
                <div>Merci beaucoup pour votre participation ! Votre événement a bien été pris en compte et ajouté dans
                    la liste des événements pour le #GivingTuesdayFr </div>
            </div>
        </form>
    </div>
</div>