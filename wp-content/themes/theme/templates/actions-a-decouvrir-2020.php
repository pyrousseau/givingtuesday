                ...
                <ul>
                    <?php foreach($newActionQuery as $key => $array) {
                        foreach ($array as $key => $post) {
                            ...
                            ?>
                            <li>
                                <div class="action-block-container categorie-<?php the_field('categorie_event'); ?>"> <!-- position:relative; -->
                                    <div class="icon-block-container"> <!-- position:absolute; top:-35px; width:100%; -->
