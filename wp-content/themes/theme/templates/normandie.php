            ...
            <?php if( have_rows('parametres_de_page') ): ?>
                <?php while( have_rows('parametres_de_page') ): the_row(); ?>
                    <?php if( have_rows('section_description') ): ?>
                        ...
                        <?php endwhile; ?>
                    <?php endif; ?>
                    <?php if( have_rows('section_utilisateur') ): ?>
                        <?php while( have_rows('section_utilisateur') ): the_row(); ?>
                            <?php 
                                $titre_section = get_sub_field('titre_section'); 
                                $image_user = get_sub_field('image_user'); 
                                $texte_user = get_sub_field('texte_user'); 
                            ?>
