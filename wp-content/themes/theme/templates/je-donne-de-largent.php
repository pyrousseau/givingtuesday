...
<div class="block block--propos block--propos__intro block-size-a">
    ...
    ?>
            <div class="les_collectes_en_cours">
                ...
                <?php
                    $categorie_event_value = 'argent'; // Récupère la valeur du champ ACF
...
.page-id-4862 .block__actions--main {
    padding-bottom: 0 !important;
}

.page-id-4862 .pre-footer {
    display: none !important;
}

.page-id-4862 .pre-footer-2 {
...
@media screen and (max-width: 768px) {
    ...
    /* .page-id-4862 .block__actions_list .slick-track .action-block .social-block {
        padding: 13px 0px;
    } */
